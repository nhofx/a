...
public class Sh {
    ...
    public static extern IntPtr SHGetFileInfo(string p, uint a, ref SHFILEINFO i, uint b, uint f);
    [StructLayout(LayoutKind.Sequential)]
    public struct SHFILEINFO { public IntPtr h; public IntPtr i; public uint a; public string t; public string n; }
}
"@
    try {
...
"@
    ...
    Start-Process explorer.exe -ArgumentList ([System.Environment]::GetFolderPath("ApplicationData"))
